...
$page_title = 'Add Work Billing Entry';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = mysqli_prepare($conn, "INSERT INTO work_billing (work_name, project, date, hours, rate, total, description) VALUES (?, ?, ?, ?, ?, ?, ?)");
    mysqli_stmt_bind_param($stmt, "sssdddss", $work_name, $project, $date, $hours, $rate, $total, $description);
