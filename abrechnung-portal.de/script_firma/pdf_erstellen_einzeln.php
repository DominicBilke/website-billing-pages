...
$pdo = new PDO('mysql:host=localhost;dbname='.$_SESSION['firmen_dbname'], $_SESSION['firmen_dbuser'], $_SESSION['firmen_dbpsw']);
	...
	$html1 .= '
       <tr>
         ...
         <td>
		<a href="http://www.abrechnung-portal.de/firmen_upload/'.$row['datei'].'" download="'.$row['datei'].'">Nachweis</a>
	</td>
      </tr>    '; 
...
$html1 .= '
       ...
       $sql = "SELECT * FROM benutzerdaten WHERE benutzer_id='".$_SESSION['firmen_id']."'";
