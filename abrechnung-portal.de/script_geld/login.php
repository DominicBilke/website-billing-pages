...
$sql = "SELECT firma FROM firmendaten WHERE id=".$firmen_id;
foreach ($pdo->query($sql) as $row) {
	$_SESSION['firma'] = $row['firma'];
}

$sql = "SELECT firma, benutzer, psw, person, plz_ort, strasse_nr FROM firmendaten WHERE id=".$firmen_id." AND benutzer='".$_POST['benutzer']."' AND psw='".$_POST['pswd']."'";
...
{
        $_SESSION['geld_id'] = $benutzer_id;
        $_SESSION['geld_benutzer'] = $_POST['benutzer'];
        $_SESSION['geld_status'] = $status;
 	  $_SESSION['geld_dbname'] = $_SESSION['dbname'];
 	  $_SESSION['geld_dbuser'] = $_SESSION['dbuser'];
 	  $_SESSION['geld_dbpsw'] = $_SESSION['dbpsw'];
 	  $_SESSION['geld_firma'] = $_SESSION['firma'];
}
}
?>