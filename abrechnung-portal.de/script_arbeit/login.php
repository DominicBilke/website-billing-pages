...
{
        $_SESSION['arbeits_id'] = $benutzer_id;
        $_SESSION['arbeits_benutzer'] = $_POST['benutzer'];
        $_SESSION['arbeits_status'] = $status;
 	  $_SESSION['arbeits_dbname'] = $_SESSION['dbname'];
 	  $_SESSION['arbeits_dbuser'] = $_SESSION['dbuser'];
 	  $_SESSION['arbeits_dbpsw'] = $_SESSION['dbpsw'];
