...
if(isset($_SESSION['arbeits_id']) && isset($_POST['tourdaten']))
{
	...
	$statement->execute(array($_SESSION['arbeits_id'], $_POST['tour'], $_POST['verteiler'], $_POST['datum'], $_POST['startzeit'], $_POST['dauer'],$_POST['pause'], $_POST['flyer'], $_POST['gebiet'], $_POST['arbeitszeit'], $_POST['monat'], $filenamejpg, $_POST['projekt'], $filenamegpx));

	/*echo "SQL Error <br />";
	echo $statement->queryString."<br />";
	echo $statement->errorInfo()[2];*/

	move_uploaded_file($_FILES['datei']['tmp_name'], '../arbeits_upload/'.$filenamejpg);
	move_uploaded_file($_FILES['gpx']['tmp_name'], '../arbeits_upload/'.$filenamegpx);
