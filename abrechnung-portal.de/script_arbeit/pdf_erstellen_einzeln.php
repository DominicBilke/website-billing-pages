...
$html1 = '<html>
	...
	<h2>Übersicht aller Arbeitswege</h2>
...
$pdo = new PDO('mysql:host=localhost;dbname='.$_SESSION['arbeits_dbname'], $_SESSION['arbeits_dbuser'], $_SESSION['arbeits_dbpsw']);
	...
	$html1 .= '
       <tr>
         ...
         <td>
		<a href="http://www.abrechnung-portal.de/arbeits_upload/'.$row['datei'].'" download="'.$row['datei'].'">Nachweis</a>
	</td>
      </tr>    '; 
...
$html1 .= '
       ...
       $sql = "SELECT * FROM benutzerdaten WHERE benutzer_id='".$_SESSION['arbeits_id']."'";
