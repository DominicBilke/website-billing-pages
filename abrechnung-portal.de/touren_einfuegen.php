...
echo '
		<h3 class="h3">Tourdaten einfügen</h3>
		<p>		
			<form action="script_touren/tourdaten.php" method="POST" autocomplete="off" enctype="multipart/form-data">
  				...
  				<label for="verteiler" class="form-label">Verteiler (Text): </label> 
  				...
  				<label for="flyer" class="form-label">Flyer (Text): </label> 
  				<input name="flyer" class="form-control" maxlength="100" type="text" required><br/>
  				<label for="gebiet" class="form-label">Gebiet (Text): </label> 
				...
				<label for="datei" class="form-label">Nachweis (png, jpg, gif):</label>
    				<input name="datei" class="form-control" type="file" size="50" accept="image/gif,image/jpeg,image/png" required> 
  				<br/>
				<label for="gpx" class="form-label">Kartendaten (gpx):</label>
    				<input name="gpx" class="form-control" type="file" size="50" accept=".gpx" required> 
  				<br/>
