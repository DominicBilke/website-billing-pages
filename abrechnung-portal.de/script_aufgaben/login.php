...
{
        $_SESSION['aufgaben_id'] = $benutzer_id;
        $_SESSION['aufgaben_benutzer'] = $_POST['benutzer'];
        $_SESSION['aufgaben_status'] = $status;
 	  $_SESSION['aufgaben_dbname'] = $_SESSION['dbname'];
 	  $_SESSION['aufgaben_dbuser'] = $_SESSION['dbuser'];
 	  $_SESSION['aufgaben_dbpsw'] = $_SESSION['dbpsw'];
