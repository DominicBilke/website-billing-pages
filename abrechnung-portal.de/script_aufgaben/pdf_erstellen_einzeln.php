...
$pdfName = "Uebersicht_".$nummer.".pdf";
    ...
    if(isset($_GET['projekt'])) {
      ...
      if($projekt == 'alle') $projekt = "";
      	...
      	$projekt = "";
	$inc_projekt = 'alle'; }
$benutzer_id = "`benutzer_id`=".$_SESSION['arbeits_id'];
...
$html1 = '<html>
	...
	<h2>Übersicht aller Aufgaben</h2>
...
$pdo = new PDO('mysql:host=localhost;dbname='.$_SESSION['aufgaben_dbname'], $_SESSION['aufgaben_dbuser'], $_SESSION['aufgaben_dbpsw']);
	...
	$html1 .= '
       <tr>
         ...
         <td>
		<a href="http://www.abrechnung-portal.de/aufgaben_upload/'.$row['datei'].'" download="'.$row['datei'].'">Nachweis</a>
	</td>
      </tr>    '; 
...
$html1 .= '
       ...
       $sql = "SELECT * FROM benutzerdaten WHERE benutzer_id='".$_SESSION['aufgaben_id']."'";
