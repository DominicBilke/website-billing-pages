...
$tlohn = number_format($tlohn, 2, ",", ".");
    ...
    <h3 class="h3"><a href="script_aufgaben/pdf_erstellen_einzeln.php'.$inc_string.'" class="text-info">[DOWNLOAD ALS PDF]</a></h3>
    <p>'.$name.'<br/>
    '.$str_nr.'<br/>
    '.$plz_ort.'</p>
...
echo '				    </select>
				...
				<input type="hidden" value="Aufgaben-Auswertung" name="menu2"/>
