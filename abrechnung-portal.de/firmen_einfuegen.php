...
echo '
		<h3 class="h3">Mitarbeiterdaten einfügen</h3>
		<p>
		
			<form action="script_firma/tourdaten.php" method="POST" autocomplete="off" enctype="multipart/form-data">
  				...
  				<label for="verteiler" class="form-label">Mitarbeiter (Text): </label> 
