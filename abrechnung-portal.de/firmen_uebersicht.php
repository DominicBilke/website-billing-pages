...
echo '	<h3 class="h3">Übersicht aller Mitarbeiter</h1>';
echo '   
...
echo '				    </select>
				...
				<input type="hidden" value="Firma-Uebersicht" name="menu2"/>
...
<table width="1024" class="table table-light">
	...
	echo '
       <tr>
         <td>'.$row['id'].'
	     <a href="firmen_upload/'.$row['datei'].'" download="'.$row['datei'].'">Nachweis</a>
         </td>
         <td>'.$row['projekt'].'
	 </td>
         <td>'.$row['verteiler'].'</td>
         ...
         <td>
		<form action="script_firma/tour_loeschen.php" method="POST" autocomplete="off">
