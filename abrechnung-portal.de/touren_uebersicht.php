...
$pdo = new PDO('mysql:host=localhost;dbname='.$_SESSION['dbname'], $_SESSION['dbuser'], $_SESSION['dbpsw']);
       ...
       if($_SESSION['touren_status'] == 'firma' )  $sql = "SELECT * FROM tourdaten";
...
echo '	<h3 class="h3">Übersicht aller Touren</h3>';
echo '   
...
echo '				    </select>
				...
				<input type="hidden" value="Touren-Uebersicht" name="menu2"/>
...
<table width="1024" class="table table-light">
	...
	echo '
       <tr>
         ...
         <td>
		<form action="script_touren/tour_loeschen.php" method="POST" autocomplete="off">
