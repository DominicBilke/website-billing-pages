...
echo '
		...
		<p>
			...
			<form action="script_arbeit/tourdaten.php" method="POST" autocomplete="off" enctype="multipart/form-data">
  				...
  				<label for="verteiler" class="form-label">Arbeiter (Text): </label> 
