...
JB.GPX2GM.setparameters = function() {  
	...
	JB.GPX2GM.parameters.doclang = (typeof(Doclang)!="undefined") ? Doclang : "de"; // de, fr oder en
	...
	JB.GPX2GM.parameters.legende_rr = (typeof(Legende_rr)!="undefined") ? Legende_rr  : false;
	...
	JB.GPX2GM.parameters.legende_info = (typeof(Legende_info)!="undefined") ? Legende_info : true;
