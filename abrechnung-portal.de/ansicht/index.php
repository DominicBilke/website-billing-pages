...
<ul class="nav justify-content-end">
 <li class="nav-item">
  ...
  <ul class="nav nav-tabs nav-justified" role="tablist">
    <li class="nav-item">
      <a class="nav-link <?php echo ($_GET['menu1'] ? "" : "active"); ?>" href="https://www.abrechnung-portal.de/ansicht/">Login</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?php echo ($_GET['menu1'] == "Tourenabrechnung" ? "active" : ""); ?>" href="https://www.abrechnung-portal.de/ansicht/index.php?menu1=Tourenabrechnung">Tourenabrechnung</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?php echo ($_GET['menu1'] == "Arbeitsabrechnung" ? "active" : ""); ?>" href="https://www.abrechnung-portal.de/ansicht/index.php?menu1=Arbeitsabrechnung">Arbeitsabrechnung</a>
    </li>
    <li class="nav-item">
      <a class="nav-link <?php echo ($_GET['menu1'] == "Aufgabenabrechnung" ? "active" : ""); ?>" href="https://www.abrechnung-portal.de/ansicht/index.php?menu1=Aufgabenabrechnung">Aufgabenabrechnung</a>
    </li>
    <!--li class="nav-item">
      <a class="nav-link <?php echo ($_GET['menu1'] == "Geldabrechnung" ? "active" : ""); ?>" href="https://www.abrechnung-portal.de/ansicht/index.php?menu1=Geldabrechnung">Geldabrechnung</a>
    </li-->
  </ul>
