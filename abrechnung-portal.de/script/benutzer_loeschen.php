...
require('../script_arbeit/benutzer_loeschen.php');
...
require('../script_geld/benutzer_loeschen.php');
...
require('../script_aufgaben/benutzer_loeschen.php');
...
require('../script_touren/benutzer_loeschen.php');
...
require('../script_firma/benutzer_loeschen.php');
