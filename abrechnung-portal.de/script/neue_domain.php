...
if($_POST['typ'] == 'Arbeitsabrechnung') require('../script_arbeit/neue_domain.php');
...
if($_POST['typ'] == 'Geldabrechnung') require('../script_geld/neue_domain.php');
...
if($_POST['typ'] == 'Aufgabenabrechnung') require('../script_aufgaben/neue_domain.php');
...
if($_POST['typ'] == 'Abrechnungstool') require('../script_touren/neue_domain.php');
...
if($_POST['typ'] == 'Firmenabrechnung') require('../script_firma/neue_domain.php');
