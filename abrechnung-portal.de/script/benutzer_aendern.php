...
require('../script_arbeit/benutzer_aendern.php');
...
require('../script_geld/benutzer_aendern.php');
...
require('../script_aufgaben/benutzer_aendern.php');
...
require('../script_touren/benutzer_aendern.php');
...
require('../script_firma/benutzer_aendern.php');
