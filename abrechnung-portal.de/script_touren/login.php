...
{
        $_SESSION['touren_id'] = $benutzer_id;
        $_SESSION['touren_benutzer'] = $_POST['benutzer'];
        $_SESSION['touren_status'] = $status;
 	  $_SESSION['touren_dbname'] = $_SESSION['dbname'];
 	  $_SESSION['touren_dbuser'] = $_SESSION['dbuser'];
 	  $_SESSION['touren_dbpsw'] = $_SESSION['dbpsw'];
}
}
?>