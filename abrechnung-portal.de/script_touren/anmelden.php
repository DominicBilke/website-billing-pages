...
$empfaenger = 'anmeldung@abrechnungstool.de';
$betreff = "Abrechnungstool.de: Anmeldung der Firma ".$_POST['firma'];
...
mail($empfaenger, $betreff, $text, $from);
	...
	header("Location: https://www.abrechnungstool.de/paypal.php");
?>