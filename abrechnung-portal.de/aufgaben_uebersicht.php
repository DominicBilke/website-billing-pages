...
echo '	<h3 class="h3">Übersicht aller Aufgaben</h1>';
echo '   
...
echo '				    </select>
				...
				<input type="hidden" value="Aufgaben-Uebersicht" name="menu2"/>
...
<table width="1024" class="table table-light">
	...
	echo '
       <tr>
         ...
         <td>
		<form action="script_aufgaben/tour_loeschen.php" method="POST" autocomplete="off">
