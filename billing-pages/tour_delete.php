...
$sql = "DELETE FROM tour_billing WHERE id = $id";
if (mysqli_query($conn, $sql)) {
    $content = display_message('success', 'Entry deleted successfully! Redirecting...');
    echo "<meta http-equiv='refresh' content='1;url=tour_overview.php'>";
} else {
    $content = display_message('danger', 'Error deleting entry. Redirecting...');
    echo "<meta http-equiv='refresh' content='2;url=tour_overview.php'>";
}
require_once('templates/base.php'); 