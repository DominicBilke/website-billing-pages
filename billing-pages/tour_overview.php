...
$search_condition = $search ? "WHERE tour_name LIKE '%$search%' OR project LIKE '%$search%'" : '';

// Get total records for pagination
$total_records_sql = "SELECT COUNT(*) as count FROM tour_billing $search_condition";
...
// Get records
$sql = "SELECT * FROM tour_billing $search_condition ORDER BY date DESC LIMIT $offset, $records_per_page";
$result = mysqli_query($conn, $sql);

$page_title = 'Tour Billing Overview';
ob_start();
?>
<div class="table-container card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Tour Billing Overview</h4>
        <form class="d-flex search-form" id="searchForm" action="tour_overview.php" method="get">
                ...
                <tbody>
                    <?php while($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="tour_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning btn-icon"><i class="fas fa-edit"></i></a>
                                <a href="tour_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger btn-icon delete-confirm"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
