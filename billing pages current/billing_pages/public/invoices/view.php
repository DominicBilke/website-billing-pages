...
<div class="invoice-container">
    <div class="invoice-header">
        ...
        <p><strong>Status:</strong> <?php echo ucfirst($invoice['status']); ?></p></span>
    </div>
    ...
    <div class="action-buttons">
        <a href="pdf.php?id=<?php echo $invoice['id']; ?>" class="btn btn-view">Download PDF</a>
        <a href="edit.php?id=<?php echo $invoice['id']; ?>" class="btn btn-edit">Edit Invoice</a>
