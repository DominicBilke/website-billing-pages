...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE invoices SET client_id = ?, date = ?, due_date = ?, status = ?, total = ? WHERE id = ? AND user_id = ?");
...
<form method="POST">
    ...
    <input type="number" id="total" name="total" step="0.01" value="<?php echo $invoice['total']; ?>" required><br>
