...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO company_billing (company_name, project, date, hours, rate, total, description, user_id) 
            VALUES ('$company_name', '$project', '$date', '$hours', '$rate', '$total', '$description', '{$_SESSION['id']}')";
...
$page_title = 'Add Company Billing Entry';
ob_start();
?>
<div class="form-container card">
    <div class="card-header"><h4>Add Company Billing Entry</h4></div>
    <div class="card-body">
        <?php echo $message; ?>
        <form method="POST">
            <div class="mb-3">
